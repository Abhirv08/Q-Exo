...
const EachRow = ({ planet_name, hostname, disc_method, disc_year, disc_facility }) => {
    return (
        <tr className='border-b-[1px] border-gray-200'>
            <td className='pl-2'>{planet_name}
            </td>
            <td className='pl-1.5 text-blue-600'>
                <a href={`https://exoplanetarchive.ipac.caltech.edu/overview/${hostname}`} target="_blank" rel="noopener noreferrer">
                    {hostname}
                </a>
            </td>
